...
{/*
        ...
        <div className='border backdrop-blur-md bg-white/90 transition-colors duration-500 hover:border-pink-500 border-gray-800 z-30 rounded-lg w-[400px] h-[400px]'>
