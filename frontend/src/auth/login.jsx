...
{/*
        ...
        <div
        className=' select-none absolute inset-0 flex z-30 items-center justify-center'>
        <div className='border backdrop-blur-md bg-white/90 border-gray-800 z-30 rounded-lg w-[400px] h-[400px]'>
            <div className='flex items-center justify-center flex-col'>
                ...
                <div className='mt-12'>
                    ...
                    onSubmit={HandleSubmit}>
                        ...
                        />
                        <input 
                        className='bg-blue-300 rounded px-4 py-1 hover:bg-blue-700 transition-colors duration-300 ease-in-out font-[600] text-white '
