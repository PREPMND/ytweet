...
{/*
        ...
        <div className='border-[1.5px] backdrop-blur-md bg-white/90 border-blue-500 transition-colors duration-500 hover:border-pink-500 z-30 shadow-lg rounded-lg w-[400px] h-[400px]'>
