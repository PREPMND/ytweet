        ...
        <>
            ...
            <div className='w-full h-[100vh] flex relative items-center justify-center'>
                ...
                <form className='flex flex-col gap-8 mb-6 w-[300px] md:w-[390px]' onSubmit={HandleSubmit}>
                    <div className={`${next ? "hidden" : "flex flex-col gap-8 mb-6 "} border-[1.5px] backdrop-blur-md bg-white/90 border-blue-500 hover:border-green-500 z-30 shadow-lg rounded-lg py-9 *:w-[220px]  md:*:w-[280px] h-full items-center justify-center transition-transform duration-500 ease-in-out 
              ${next ? "-translate-x-full opacity-0" : "translate-x-0 opacity-100"}w-full `}>
                    ...
                    <div className={`${next ? "flex flex-col justify-center items-center" : "hidden"} *:mb-5 z-30 text-center font-[700] h-screen`}>
