            ...
            >
                {videos.map((video) => (
                    <div
                        ...
                        className="overflow-hidden shadow-sm mb-4 rounded-[2vh] cursor-pointer transition-transform relative duration-500 ease-in-out"
                    >
                        {playingId === video._id ? (
                            <video
                                src={video.videoFile}
                        ...
                        <div
                            className="flex flex-start items-center leading-[1.4] h-[80px] mt-1 ml-2">
                            <img className="w-9 h-9 hover:ring-1 hover:scale-105 hover:ring-blue-300 shrink-0 transition-transform duration-500 ease-in-out rounded-full object-cover" src={video.owner.avatar} alt="Avatar" />
