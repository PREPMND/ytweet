...
const VideoList = (props) => {
    ...
    return (
        <div
            className={`relative overflow-hidden cursor-pointer transition-all duration-300 ease-out min-h-screen will-change-transform pt-9 transform-gpu ${darkMode ? "bg-black" : "bg-white"
                }`}
        >
            <div
                    ...
                    .map((video, idx) => (
                        ...
                        >
                            <div className="relative aspect-video select-none overflow-hidden rounded-xl bg-black">
                                ...
                                <span
                                    className="absolute bottom-2 right-2 bg-black/90 text-white text-[15px] font-semibold px-2 py-[2px] rounded"
                                >
