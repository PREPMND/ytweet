...
const VideoList = (props) => {
    ...
    return (
        <div
            className={`relative overflow-hidden pb-[70px] min-h-screen cursor-pointer transition-all duration-300 ease-out will-change-transform pt-9 transform-gpu ${darkMode ? "bg-black" : "bg-white"
                }`}
        >
            <div
