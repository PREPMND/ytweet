            ...
            >
                {videos.map((video) => (
                    ...
                    >
                        ...
                        <div
                            className="flex flex-start items-center leading-[1.4] h-[80px] mt-1 ml-2"><img className="min-w-5 max-w-7 max-h-7 min-h-5  rounded-full object-cover" src={video.owner.avatar} alt="Avatar" />
