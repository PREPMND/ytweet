...
const VideoList = (props) => {
    ...
    return (
        <div
            className={`relative overflow-hidden md:pb-[70px] min-h-screen cursor-pointer transition-all duration-300 ease-out will-change-transform pt-9 transform-gpu ${darkMode ? "bg-black" : "bg-white"
                }`}
        >
            <div
                                ...
                                <div
                                    ...
                                    >
                                        <h3
                                            ...
                                            className={`md:text-[14px] text-[15px] leading-5 font-[500] line-clamp-2 break-words ${darkMode
                                                ? "text-white"
                                                : "text-black"
                                                }`}
                                        >
                                        ...
                                        <p
                                            ...
                                            className={`text-[14px] md:text-[15px] font-[400] md:text-sm mt-1 hover:underline truncate ${darkMode
                                                ? "text-neutral-300"
                                                : "text-neutral-700"
                                                }`}
                                        >
