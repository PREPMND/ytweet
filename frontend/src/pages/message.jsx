...
export default function Messages({ currentId }) {
    ...
    return (
        ...
        <div className={`w-full  h-screen no-scrollbar overflow-y-auto`}   >
            ...
            <div className={`w-full h-[calc(100%-50px)] overflow-y-auto flex flex-col gap-2 p-2 pl-4 pr-4 no-scrollbar`}>
            ...
            <div className="flex items-center md:left-3 gap-2 p-3 border-t bg-white sticky bottom-0">
                ...
                <input
                    ...
                    placeholder="Type..."
                    className=" md:max-w-[70%] bg-black  hover:border-slate-700 hover:border-1 border-1 border-neutral-900 rounded-md px-3 py-2"
                />
                <button
                    onClick={sendMessage}
