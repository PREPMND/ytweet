            ...
            <div>
                {videos.map((video, index) => (
                    <div
                        ...
                        <div className="flex items-center h-12 px-2 mb-3 md:mb-0 justify-between w-full gap-2 ">
                            <h3 className="mt-2 pl-[10px] font-[600] md:hidden flex text-[15px] md:text-[18px]">{video.title}</h3>
                            <EllipsisVertical className="text-[18px]  cursor-pointer absolute right-2"  />
                        </div>
