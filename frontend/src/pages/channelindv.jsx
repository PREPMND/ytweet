            ...
            <div>
                {videos.map((video, index) => (
                    <div
                        ...
                        <div className="w-full md:w-[80%] mx-3 md:mx-0 flex gap-5 ">
                            <img className="object-cover mx-3 aspect-[16/9] rounded-md w-[90%] md:w-[50%]" src={video.thumbnail} alt={video.title} />
