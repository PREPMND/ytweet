...
const ChannelIndv = (props) => {
    ...
    return (
        ...
        <div className={`relative min-h-calc([100vh+12px]) ${darkMode ? "bg-black text-white" : "bg-white text-black"
            }`}>
                ...
                {videos.map((video, index) => (
                    ...
                    <div
                        ...
                        <div className={`w-full relative px-3 md:mx-0 flex `}>
                            ...
                            />
                            <h3
                                className={`md:mt-[1px] mt-3 ml-5 hidden md:flex font-[600] text-[18px]
