        ...
        <div className={`relative ${darkMode ? "bg-black text-white" : "bg-white text-black"
            ...
            <div className={`relative w-full ${!imageLoaded ? 'animate-pulse' : ''}`}>
                <img
                    ...
                    className={` ${imageLoaded?"":"hidden"} -mt-5 inset-0  rounded-b-lg w-full h-[140px] object-cover `} src={coverImage} />
            </div>
...
${yangSelected
            ...
            <div>
                {videos.map((video, index) => (
                    ...
                    <div
                        className="flex md:flex-row h-screen flex-col justify-between pb-4"
                        key={video._id || index}>
