...
const ChannelIndv = (props) => {
    ...
    useEffect(() => {
        channelVideo(profileSelected._id);
    ...
    return (
        <div className="relative">
            ...
            <img className="ml-6 md:ml-9 rounded-[100%] w-[100px] h-[100px] md:h-[20%] md:w-[20%]" src={profileSelected.avatar} alt={profileSelected.username} />
