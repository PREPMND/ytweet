...
const Navbar = () => {
    ...
    return (
        <>
            <div>
                <div className="flex items-center inset-0 z-0 h-[80px] justify-between">
            ...
            {
                navigate && <div className="w-[60%] h-[60%] md:w-[40%] md:h-[40%] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white/30 rounded-lg shadow-lg flex flex-col items-center mt-3 justify-center gap-6 z-40 inset-0 m-auto">
