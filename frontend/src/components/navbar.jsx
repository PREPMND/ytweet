    ...
    return (
        <>
            ...
            <div className={`hidden md:flex items-center w-full pt-1 pb-1  px-10 ${darkMode ? "bg-black  text-white" : ""}`}>
                ...
                <MessageCircleDashedIcon className={`hover:scale-110 transition-transform duration-200 ease-in hover:shadow-lg hover:shadow-amber-200 hover:text-amber-200 mr-1 ml-4`}/>
            </div>
        </>
    )
}
