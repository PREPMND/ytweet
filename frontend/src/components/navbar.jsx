...
const Navbar = () => {
    ...
    return (
        <>
            ...
            {
                navigate && <div className="w-[40%] h-[40%] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white/30 rounded-lg shadow-lg flex flex-col items-center justify-center gap-6 z-40 inset-0 m-auto">
