                    ...
                    <div className={`relative w-[60%] md:w-[30%] h-full shadow-lg flex flex-col pl-6 pt-5 gap-6 z-50 ${darkModenav ? "bg-neutral-900 shadow-lg shadow-neutral-200 text-white" : "bg-white"} select-none`}>
                        <div>
                            ...
                            <div className="flex items-center flex-col justify-center mr-6">
                                ...
                                <button className={`border-2 px-3 mt-3 py-1 rounded-[12px] text-[18px] font-[400] transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-stone-500 hover:shadow-sm ${darkModenav ? "text-neutral-900 bg-white hover:text-black border-gray-600" : "text-neutral-900 hover:text-black"}`}>
                                    Account Details
                                </button>
                            </div>
