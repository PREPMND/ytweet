                    ...
                    <div
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div className={`flex items-center transition-colors duration-100 ease-in-out mt-5 ${darkMode ? "text-white hover:text-white/95" : "text-slate-900 hover:text-black"}`}>
                                    <Album className="mr-5 md:mr-7" size={24} />
                                    <span className="ml-2 hover:scale-105 transition-transform hover:text-amber-100 duration-200 ease-out md:text-[20px] text-[15px] font-[500]">Manage Videos</span>
                            ...
                            <div className={` ${darkMode ? "text-white" : "text-stone-900"} text-[12px] text-center mt-6  border-[1px] w-[260px]`}></div>

                            <button
                                onClick={() => setDarkMode(!darkMode)}
                                className="w-32 h-8 ml-5 text-sm text-center flex justify-center items-center mt-3 rounded bg-gray-800 text-white hover:bg-gray-700"
                            >
                                Toggle Dark Mode
                            </button>

                            <div className="w-full mb-3 ml-5">
                                <button
                                    onClick={HandleLogout}
                                    className={`w-32 h-8 text-sm text-center flex justify-center items-center mt-4 rounded bg-red-600 text-white hover:bg-red-500 ${isLoggedIn ? "flex" : "hidden"}`}
                                >
                                    Log Out
                                </button>
                            </div>
