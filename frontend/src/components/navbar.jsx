        ...
        <>
            ...
            {navigate && (
                <div className="fixed inset-0 z-40 flex items-center justify-center">
                    ...
                    <div className={`relative md:w-[50%] md:h-[40%] rounded-lg shadow-lg flex flex-col items-center justify-center gap-6 z-50 ${darkMode ? "bg-gray-900 text-white" : "bg-white"}`}>
