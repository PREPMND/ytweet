                    ...
                    <div className={`relative w-[60%] md:w-[30%] h-full shadow-lg flex flex-col pl-[44px] pt-5 gap-6 z-50 ${darkMode ? "bg-neutral-900 shadow-lg shadow-neutral-200 text-white" : "bg-white"} select-none overflow-y-scroll`}>
                        <div>
                            ...
                            <div className="flex items-center flex-col justify-center mr-[40px] mb-4">
                                ...
                                <button className={`border-2 px-2 md:px-3 mt-2 md:mt-3 py-1 rounded-[12px] text-[13px]  md:text-[18px] text-neutral-900 font-[400]hover:text-black transition-all duration-300 ease-in-out hover:scale-105  hover:shadow-sm ${darkMode?"text-black bg-white  hover:shadow-fuchsia-400 hover:shadow-md":"hover:shadow-stone-500"}`} >
