        ...
        <>
            ...
            <div className={`hidden md:flex items-center w-full pt-1 pb-1  px-10 ${darkMode ? "bg-black  text-white" : ""}`}>
                <form className="w-full flex items-center">
                    <input className={`w-[70%] hover:bg-neutral-700 transition-colors  ease-in-out pl-8 h-9 ${darkMode?"bg-neutral-800 text-white":"text-black bg-slate-300"}`} type="text"/>
                    <ScanSearch className="ml-3" size={28}/>
                </form>
                <div className="text-[18px] font-[Saira]">Messages</div>
                <MessageCircleDashedIcon className={`hover:scale-110 transition-transform duration-200 ease-in hover:shadow-lg hover:shadow-amber-200 hover:text-blue-400 mr-1 ml-4`}/>
            </div>
        </>
    )
}
