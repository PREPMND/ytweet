    ...
    return (
        <>
            <div className={darkMode ? "bg-black text-white" : ""}>
                <div className="flex items-center inset-0 z-0 h-[80px] justify-between border-b border-gray-700">
                    ...
                    <div className="w-fit sm:flex absolute hidden left-1/2 top-3">
                        <img className="w-12 h-12 object-cover" src={darkMode ? logolight : logodark} />
                    </div>
