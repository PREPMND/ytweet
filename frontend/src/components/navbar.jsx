                    ...
                    <div className={`relative w-[60%] md:w-[30%] h-full shadow-lg flex flex-col pl-6 pt-5 gap-6 z-50 ${darkModenav ? "bg-neutral-900 shadow-lg shadow-neutral-200 text-white" : "bg-white"} select-none`}>
                        <div>
                            ...
                            <div className="flex items-center flex-col justify-center mr-6">
                                ...
                                <button className={`border-2 px-3 mt-3 py-1 rounded-[12px] text-[18px] text-neutral-900 font-[400]hover:text-black transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-stone-500 hover:shadow-sm ${darkModenav?"text-black bg-white/20":""}`} >Account Details</button>
                            </div>
