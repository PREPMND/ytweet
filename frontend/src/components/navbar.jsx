                    ...
                    <div
                        ...
                        <div>
                            ...
                            <button
                                ...
                                className="w-32 h-8 ml-3 md:ml-5 text-sm text-center flex justify-center items-center mt-3 rounded bg-gray-800 text-white hover:bg-gray-700"
                            >
                                Toggle Dark Mode
                            </button>

                            <div className="w-full mb-3 ml-3 md:ml-5">
                                <button
