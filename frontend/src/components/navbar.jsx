            ...
            <div>
                <div className="flex items-center h-[80px] justify-between">
                    ...
                    <div className="flex items-center  mt-4 gap-11 z-20 pr-9">
                        ...
                        >
                            <Airplay className={`${hoverAirplay ? "text-yellow-400 shadow-sm shadow-yellow-300 scale-105" : ""}`} />
                            <span
                        ...
                        >
                            ...
                            <span
                                className={`text-[11px] text-gray-600 font-[600] mt-1 transition-opacity duration-300 ${hoverBolt ? "opacity-100" : "opacity-0"
                                    }`}
                            >
                                PREP
                            </span>
