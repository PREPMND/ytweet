        ...
        <>
            ...
            {menubar && (
                <div className="fixed inset-0 z-50 flex">
                    ...
                    className={`relative w-[60%] md:w-[40%] lg:w-[30%] h-full shadow-lg flex flex-col pl-[30px] md:pl-[44px] pt-5 gap-6 z-50 ${darkMode ? "bg-neutral-900 shadow-lg shadow-neutral-200 text-white" : "bg-white"} select-none overflow-y-scroll`}>
                        <div>
